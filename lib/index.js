 ...
 * @param {Array<string|{name: string, prefix: string, suffix: string, replacement?: string}>|undefined} [options.blocks]
 *
 * @return {string}
 *
...
/**
 * @param {Array<string|{name: string, prefix: string, suffix: string, replacement?: string}>|undefined} blocks
 *
 * @return {boolean}
 */
...
/**
 * @param {string} content
 * @param {Array<string|{name: string, prefix: string, suffix: string, replacement?: string}>} blockOptions
 *
 * @return {string}
 */
function removeBlocksFrom(content, blockOptions) {
...
/**
 * @param {string|{name: string, prefix: string, suffix: string, replacement?: string}} option
 *
...
function prepareBlockFromOption(option) {
  ...
  if (typeof option === 'string') {
    block = generateBlockFromString(option);
  }
...
/**
 * @param {{name: string, prefix: string, suffix: string, replacement?: string}} values
 *
 * @return {{start: string, end: string, prefix: string, suffix: string, replacement?: string}}
 */
function generateBlockFromObject(values) {
  const defaults = generateBlockFromString(values.name);
