...
/**
 * @param {string} content
 * @param {Array<string|{name: string, prefix: string, suffix: string, replacement?: string}>} optionsBlocks
 *
 * @return {string}
 */
function removeBlocksFrom(content, optionsBlocks) {
  optionsBlocks.forEach(function (optionsBlock) {
    const block = prepareBlockFromOption(optionsBlock);
...
/**
 * @param {string|{name: string, prefix: string, suffix: string, replacement?: string}} representation
 *
...
function prepareBlockFromOption(representation) {
  ...
  if (typeof representation === 'string') {
    block = generateBlockFromString(representation);
  }
